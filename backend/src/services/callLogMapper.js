...
// --- Vapi mapping -----------------------------------------------------------
// Maps a Vapi end-of-call-report / status-update message onto the same normalized shape the
// webhook consumes. Deliberately kept beside extractCallFields (Dograh) without altering it.
...
// Mirrors normalizeLeadData's output keys; returns {} when no structured data is present so the
// webhook's autoGenerateLeadFromCall fallback takes over (same behavior as Dograh).
